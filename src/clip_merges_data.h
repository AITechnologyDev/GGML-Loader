#pragma once
// Standard OpenAI CLIP BPE merges (bpe_simple_vocab_16e6.txt convention): a "#version: 0.2"
// header line + 48894 merge rules, byte-for-byte identical to what every SD1.x/SDXL
// checkpoint (including stable-diffusion.cpp's own conversions) was tokenized with. Public,
// MIT-licensed data (github.com/openai/CLIP); this copy is from
// huggingface.co/openai/clip-vit-large-patch14/raw/main/merges.txt.
static const char * const CLIP_MERGES_DATA = R"CLIPMERGES(
#version: 0.2
i n
t h
a n
